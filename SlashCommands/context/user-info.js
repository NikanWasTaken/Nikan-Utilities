const { Client, MessageEmbed, MessageButton, MessageActionRow, ContextMenuInteraction } = require("discord.js");
...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    if (member) user = interaction.guild.members.cache.get(interaction.targetId).user
